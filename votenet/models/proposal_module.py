...
from votenet.pointnet2.pointnet2_modules import PointnetSAModuleVotes
from votenet.pointnet2 import pointnet2_utils
...
class ProposalModule(nn.Module):
    ...
    def forward(self, xyz, features, end_points):
        ...
        if self.sampling == 'vote_fps':
            ...
            logger.error('Unknown sampling strategy: %s. Exiting!'%(self.sampling))
            exit()
...
if __name__=='__main__':
    from votenet.sunrgbd.sunrgbd_detection_dataset import SunrgbdDetectionVotesDataset, DC
