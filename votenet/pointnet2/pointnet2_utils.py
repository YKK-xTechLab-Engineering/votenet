...
from votenet.pointnet2 import pytorch_utils as pt_utils
import sys
...
try:
    ...
    try:
        import pointnet2._ext as _ext  # legacy/standalone build fallback
    except ImportError:
        if not getattr(builtins, "__POINTNET2_SETUP__", False):
            raise ImportError(
                "Could not import _ext module.\n"
                "Ensure the CUDA extension is built. Try `pip install -e . --no-build-isolation` "
